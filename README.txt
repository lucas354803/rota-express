...
CORREÇÃO 26/04 - PIX, MOTOBOY E RELATÓRIOS
- Pix confirmado pelo Mercado Pago libera automaticamente para os motoboys.
- O verificador automático não volta mais uma entrega finalizada para liberada.
- Entrega finalizada sai de Minhas corridas e aparece na aba Relatório de entregas do motoboy.
- Admin vê histórico de entregas mesmo se a tabela de histórico falhar, usando os pedidos finalizados como garantia visual.
- Cálculo de valores por motoboy corrigido com comparação segura de IDs.

IMPORTANTE NA VERCEL:
Configure as variáveis MP_TOKEN e, de preferência, SUPABASE_SERVICE_ROLE_KEY.
Sem MP_TOKEN o Pix automático não consegue consultar aprovação real no Mercado Pago.
